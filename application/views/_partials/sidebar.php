<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#perwalian" class="nav-link active" aria-controls="perwalian" role="button" aria-expanded="false">
          ...
          <span class="sidenav-normal"> Lihat Data Diri </span>
          </a>
          </li>
          <li class="nav-item ">
          <a class="nav-link " href="../../pages/dashboards/automotive.html">
          <span class="sidenav-mini-icon"> A </span>
          <span class="sidenav-normal"> Edit Data Diri </span>
          </a>
          </li>
          <li class="nav-item ">
