                    ...
                    <div class="card-body">
                        <div class>
                            <div class="table-responsive">
                                <table class="table  align-items-center mb-0 ps-3">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr data-bs-toggle="collapse" data-bs-target="#r1">
                                            <td>1 <i class="bi bi-chevron-down"></i></td>
                                            <td>200102011</td>
                                        ...
                                        <tr data-bs-toggle="collapse" data-bs-target="#r2">
                                            <td>2 <i class="bi bi-chevron-down"></i></td>
                                            <td>200102011</td>
                                            <td>Renal Sukma Widiarsa</td>
                                            <td>L</td>
                                            <td>2020</td>
                                        ...
                                        <tr data-bs-toggle="collapse" data-bs-target="#r3">
                                            <td>3<i class="bi bi-chevron-down"></i></td>
                                            <td>200102011</td>
                                            <td>Renal Sukma Widiarsa</td>
                                            <td>L</td>
                                            <td>2020</td>
