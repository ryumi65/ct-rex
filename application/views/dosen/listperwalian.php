            ...
            <div class="d-flex d-inline mt-4 mb-3">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-gray-100 my-0 py-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Daftar Perwalian</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-12 my-3">
                <div class="card">
                    <div class="card-header p-3">
                        <h5 class="mb-0">Daftar Perwalian <?= $dosen['nama'] ?></h5>
                    </div>
                                ...
                                <?php foreach ($listm as $mahasiswa) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= site_url('dosen/cstudimhs') ?>" class="badge bg-primary px-3 py-2" data-bs-toggle="tooltip" title="Data Akademik">
