                                ...
                                <?php foreach ($listd as $dosen) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= site_url('fakultas/civitas/data-dosen/' . $dosen['nik'] . '/profil') ?>" class="badge bg-info px-3 py-2" data-bs-toggle="tooltip" title="Data Diri">
                                                <i class="fa-solid fa-user"></i>
                                            </a>
                                            <a href="<?= site_url('fakultas/civitas/data-dosen/' . $dosen['nik'] . '/jadwal') ?>" class="badge bg-primary px-3 py-2" data-bs-toggle="tooltip" title="Data Mengajar">
