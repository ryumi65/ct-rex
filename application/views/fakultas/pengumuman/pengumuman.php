            ...
            <div class="col-12 my-3">
                <div class="card">
                    <div class="card-header d-flex justify-content-between p-3">
                        <h5 class="mb-0">Pengumuman Fakultas Sains dan Teknologi</h5>
                        <a href="<?= site_url('fakultas/inputpengumuman') ?>" class="btn btn-primary btn-sm mb-0">Buat Pengumuman</a>
                    </div>
                                ...
                                <?php foreach ($listp as $pengumuman) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= site_url('fakultas/pengumuman/' . $pengumuman['id_pengumuman'] . '/edit') ?>" class="badge bg-warning px-3 py-2" data-bs-toggle="tooltip" title="Edit">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <a class="badge bg-danger cursor-pointer px-3 py-2" data-bs-toggle="tooltip" title="Hapus" onclick="deleteAlert('<?= site_url('fakultas/pengumuman/' . $pengumuman['id_pengumuman'] . '/delete') ?>')">
