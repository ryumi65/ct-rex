            ...
            <div class="card mx-auto">
                <div class="card-header pb-0">
                    ...
                    <div class="card-body">
                        ...
                        <label>ID Akun</label>
                        <div class="mb-3">
                            <input type="text" name="id_akun" class="form-control" placeholder="ID Akun" size="30" required>
                        </div>
                        <label>Username</label>
                        <div class="mb-3">
                            <input type="text" name="username" class="form-control" placeholder="Username" size="30" required>
                        </div>
                        <label>Password</label>
                        <div class="mb-3">
                            <input type="password" name="password" class="form-control" placeholder="Password" size="30" required>
                        </div>
                        <label>Level</label>
                        <div class="mb-3">
